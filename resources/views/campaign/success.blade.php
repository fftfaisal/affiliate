    ...
    <div class="flex items-center justify-center h-screen">
        <div class="p-1 rounded shadow-lg">
            <div class="flex items-center p-4 bg-white">
                ...
                <p class="text-4xl mt-0 font-bold text-transparent text-[#a35ca3]">Thank you for signup. <a href="https://samsonqbank.com/users/register" class="text-black">Click here</a> to complete your payment</p>
            </div>
        </div>
    </div>
</x-campaign-layout>
